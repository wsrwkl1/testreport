...
def blComReasult(request):
    ...
    if not p0 or not p1:
        ...
        error = True
        info = "请选择所要搜索的产品"
    elif not version0 and not version1:
    ...
    #print len(p)
        ...
        c_dic = {'result_list':result_list,'product0':p0,'product1':p1,'version0':version0,'version1':version1}
...
def currcompare(request):
    ...
    #print len(p)
        ...
        c_dic = {'result0':result0,'result1':result1,'product0':p0,'product1':p1,'version0':version0,'version1':version1}
        dic = dict(v_dic,**c_dic)
